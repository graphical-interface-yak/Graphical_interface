...
class inputBox(object):
    ...
    def __init__(self, x, y, width, height, text, font_size, color_active, color_inactive, font_color):
        ...
        self.color_active_input_box = color_active #pygame.Color(32, 185, 255, 255)
        self.color_inactive_input_box = color_inactive #pygame.Color(0, 41, 63, 255)
    ...
    def check_text_within_box(self): # + 27
        return (self.text_input_box.get_width() + 34) < (self.input_box.w + self.input_box.x)
